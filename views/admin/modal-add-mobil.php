            ...
            <form action="../../logics/admin/crud-mobil.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col">
                            <div class="mb-3">
                                <label for="gambar_mobil" class="form-label">Main Car Image (Untuk hero section)</label>
                                <input type="file" class="form-control" id="gambar_mobil" name="gambar_mobil" accept="image/*" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                <label for="gambar_mobil_overview" class="form-label">Overview Car Image (untuk thumbnail)</label>
